    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          >
            <input type="hidden" name="access_key" value="d1e2c608-ca84-4817-91fc-4597f61e5c91"></input>
            ...
            >
              <h2 className={`text-2xl font-bold mb-2 ${themeClasses.text} pr-8`}>Get Special Discounts</h2>
              <p className={`${themeClasses.textMuted} mb-4 text-sm`}>
                Enter your details to unlock exclusive offers and privileges.
              </p>
            </motion.div>
            ...
            >
              <span className={`text-sm font-medium ${themeClasses.textSecondary}`}>Email</span>
              <input
                type="email"
                name="email"
                className={`${themeClasses.inputBg} border ${themeClasses.inputBorder} rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-yellow-500 ${themeClasses.inputFocus} focus:border-transparent text-base ${themeClasses.text}`}
            ...
            >
              <span className={`text-sm font-medium ${themeClasses.textSecondary}`}>Phone</span>
              <input
                type="tel"
                name="phone"
                className={`${themeClasses.inputBg} border ${themeClasses.inputBorder} rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-yellow-500 ${themeClasses.inputFocus} focus:border-transparent text-base ${themeClasses.text}`}
